...
{
    public float _wantedAspectRatio = 1920f / 1080f;
    ...
    public static void SetCamera(AspectRatioEnforcer obj)
    {
        ...
        if (currentAspectRatio > wantedAspectRatio) // Pillarbox
        {
        ...
        if (!backgroundCam)
        {
            ...
            GameObject backgroundCameraObj = new GameObject("BackgroundCam", typeof(Camera));
            backgroundCam = (Camera)backgroundCameraObj.GetComponent(typeof(Camera));
            backgroundCam.transform.parent = obj.transform;
