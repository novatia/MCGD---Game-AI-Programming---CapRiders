...
public class tnUISubbuteoScorePanel : MonoBehaviour
{
    [SerializeField]
    ...
    private tnSubbuteoMatchController m_MatchController = null;

    public void Bind(tnSubbuteoMatchController i_MatchController)
    {
    ...
    void Update()
    {
        ...
        tnSubbuteoMatchTeamResults teamResults0 = (tnSubbuteoMatchTeamResults)m_MatchController.GetTeamResultsByIndex(0);
        ...
        tnSubbuteoMatchTeamResults teamResults1 = (tnSubbuteoMatchTeamResults)m_MatchController.GetTeamResultsByIndex(1);
