...
public class UserStatFloatCondition : UserStatCondition
{
    ...
    private bool InternalEvaluate()
    {
        if (m_Stat != null)
        {
            float statValue = m_Stat.floatValue;
    ...
    public UserStatFloatCondition(string i_StatId, NumericConditionType i_ConditionType, float i_Value)
    {
        m_StatId = i_StatId;
