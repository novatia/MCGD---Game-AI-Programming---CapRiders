...
namespace GoUI
{
    public sealed class UINavbarElement : MonoBehaviour
    {
        [SerializeField]
        ...
        private void InternalSetBackEnabled(bool i_Enabled)
        {
            if (m_Back != null)
            {
                m_Back.enabled = i_Enabled;
            }
        }
        ...
        {
            InternalSetBackEnabled(i_Visible);
        ...
        void Update()
        {
            if (m_Animator != null)
            {
                ...
                {
                    m_Animator.Safe_SetBool(s_Visible, m_Visible);
                    m_Animator.Safe_SetBool(s_Active, m_Active);
                }
            }
